...
//password reset
Route::post('/application/password/reset', [ResetPasswordController::class, "tokenResetPasswordExist"]);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    //password reset
    Route::post('/application/send/reset/link', [ResetPasswordController::class, "sendResetLinkPassword"]);
