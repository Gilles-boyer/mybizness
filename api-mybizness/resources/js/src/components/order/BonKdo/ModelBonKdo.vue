<template>
  <v-card
    :style="fontFamily"
    class="rounded-xl white--text mt-4 mb-4"
    :color="Color"
  >
    <v-row justify="center" align-content="center" class="f100 pa-2">
      <v-col cols="3">
        <v-img
          :aspect-ratio="sizeImg"
        ...
        >
          <v-col cols="12">
            <v-row justify="space-between" align-content="space-between">
              ...
              <v-col cols="3">
                <v-img alt="CFG logo" src="/assets/logoCfg.png" />
              </v-col>
            </v-row>
          </v-col>
          <v-col cols="6" class="pa-0">
            ...
            <v-card
              color="white"
              class="rounded-xl primary--text text-center"
              width="100%"
              min-height="50px"
              elevation="0"
            >
  ...
  computed: {
    ...
    Color: {
      get() {
        ...
        return this.getPersonalization.color.hex;
      },
    },
    image: {
      get() {
    ...
    fontFamily() {
      return `font-family: ${this.font} , sans-serif;`;
    },
  },
  created() {
